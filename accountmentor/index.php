...
if (isset($_POST['submit'])) {
	...
	$sql = "SELECT * FROM mentor WHERE email='$email' AND password='$password'";
	...
	if ($result->num_rows > 0) {
		...
		echo "<script>alert('Oeps! Email of wachtwoord is verkeerd.')</script>";
	}
}
...
<head>
	...
	<title>Inloggen Mentor</title>
</head>
<body>
	<div class="container">
		<form action="" method="POST" class="login-email">
			<p class="login-text" style="font-size: 2rem; font-weight: 800;">Inloggen Mentor</p>
